  ...
  const faqs: FAQItem[] = [
    {
      ...
      answer:
        "Hanya 10 menit dari RSUD Prof. Dr. Margono Soekarjo, 7 menit dari Depo Pelita Sokaraja, dan 10 menit ke Alun-Alun Purwokerto. Dekat juga dengan sekolah, pasar tradisional, serta fasilitas umum lainnya yang memudahkan aktivitas sehari-hari.",
    },
    {
      question: "Apa saja fasilitas umum yang disediakan di dalam Samara Pegalongan?",
      answer:
        "Di Samara Asri Wiradadi kami menghadirkan lingkungan dengan fasilitas modern dan nyaman. Kami juga mengutamakan keamanan dengan one gate system dan penjagaan dari sekuriti selama 24 jam untuk menjaga kawasan tetap aman.",
    },
    {
      question: "Apakah rumah di Samara Asri Wiradadi sudah memiliki sertifikat hak milik (SHM)?",
      answer:
        "Di Samara Asri Wiradadi, kami sudah mengurus proses pemecahan sertifikat, jadi saat serah terima nanti, sertifikatnya langsung atas nama Bapak/Ibu. Hal ini mempermudah dan mempercepat proses kepemilikan tanpa perlu menunggu lama untuk pengurusan balik nama. Kami memastikan urusan administrasi menjadi lebih praktis untuk Bapak/Ibu, jadi begitu Anda menerima kunci, status kepemilikan sudah resmi atas nama Anda.",
    },
    {
      question: "Apakah sertifikat ini aman dari masalah hukum di kemudian hari?",
      answer:
        "Mengenai legalitas di Samara Asri Wiradadi, semua sudah lengkap dan aman, Bapak/Ibu. Properti di sini dilengkapi Sertifikat Hak Milik (SHM), jadi kepemilikannya jelas atas nama pembeli. Izin bangunannya juga sudah ada melalui Persetujuan Bangunan Gedung (PBG), artinya bangunan sudah sesuai aturan dan aman.",
    },
    {
    ...
    {
      question: "Apakah rumah di Samara Asri Wiradadi sudah memiliki PBG?",
      answer:
        "Rumah di Samara Asri Wiradadi sudah memiliki Persetujuan Bangunan Gedung (PBG), jadi Anda tidak perlu khawatir soal legalitas bangunan ini. PBG ini memastikan bahwa proses pembangunan sudah sesuai dengan peraturan yang berlaku, sehingga hunian di sini aman dan sah untuk ditinggali, maupun sebagai investasi jangka panjang.",
    },
    {
    ...
    <section id="faq" className="faq-section">
      <div className="container">
        <div className="faq-header">
          <h2 className="faq-title">Pertanyaan Umum Samara Asri Wiradadi</h2>
