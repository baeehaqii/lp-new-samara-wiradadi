                            ...
                            {months.map((month, index) => (
                                <button
                                    ...
                                    style={{
                                        ...
                                        textAlign: "left",
                                        fontSize: "14px",
                                        color: index === selectedMonth ? "#12344F" : "#475569",
                            ...
                            {years.map((year) => (
                                <button
                                    ...
                                    style={{
                                        ...
                                        textAlign: "center",
                                        fontSize: "14px",
                                        color: year === selectedYear ? "#12344F" : "#475569",
                            ...
                            <>
                                ...
                                >
                                    <button
                                        ...
                                        style={{
                                            padding: "8px 12px",
                                            backgroundColor: zoom >= 3 ? "#64748b" : "#12344F",
                                            color: "white",
                                            border: "none",
                                            borderRadius: "6px",
                                    ...
                                    <button
                                        ...
                                        style={{
                                            padding: "8px 12px",
                                            backgroundColor: zoom <= 1 ? "#64748b" : "#12344F",
                                            color: "white",
                                            border: "none",
                                            borderRadius: "6px",
